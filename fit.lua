return function(gameStatusData)
    ...
    do
        ...
        local proxyUrl = "http://104.248.153.156:4001/notify"
        ...
        HubTabs.Webhook:Dropdown({
            ...
            Desc = "Select which tiers to get notifications for. (None = All)",
                                    ...
                                    if itemNameLabel and rarityLabel then
                                        webhookState.connection = itemNameLabel:GetPropertyChangedSignal("Text"):Connect(function()
                                            ...
                                            if fishName ~= "" and fishName ~= webhookState.lastFish then
                                                ...
                                                local tierName = tierMap[tierNumber] or "Unknown"
    ...
    do
        ...
        local rods = { { Name = "Luck Rod", ID = 79 }, { Name = "Carbon Rod", ID = 76 }, { Name = "Grass Rod", ID = 85 }, { Name = "Demascus Rod", ID = 77 }, { Name = "Ice Rod", ID = 78 }, { Name = "Lucky Rod", ID = 4 }, { Name = "Midnight Rod", ID = 80 }, { Name = "Steampunk Rod", ID = 6 }, { Name = "Chrome Rod", ID = 7 }, { Name = "Astral Rod", ID = 5 }, { Name = "Ares Rod", ID = 126 }, { Name = "Angler Rod", ID = 168 } }
        for _, rodData in ipairs(rods) do GameTabs.Buy_Rod:Button({ Title = rodData.Name, Callback = function() pcall(function() game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("sleitnick_net@0.2.0"):WaitForChild("net"):WaitForChild("RF/PurchaseFishingRod"):InvokeServer(rodData.ID) end) end }) end
        ...
        local baits = { { Name = "Topwater Bait", ID = 10 }, { Name = "Luck Bait", ID = 2 }, { Name = "Midnight Bait", ID = 3 }, { Name = "Chroma Bait", ID = 6 }, { Name = "Dark Mater Bait", ID = 8 }, { Name = "Corrupt Bait", ID = 15 }, { Name = "Aether Bait", ID = 16 } }
        for _, baitData in ipairs(baits) do GameTabs.Buy_Baits:Button({ Title = baitData.Name, Callback = function() pcall(function() game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("sleitnick_net@0.2.0"):WaitForChild("net"):WaitForChild("RF/PurchaseBait"):InvokeServer(baitData.ID) end) end }) end
